...
def analisador_sentimento(produto):
    prompt_sistema = f"""
        ...
        Indentique também 3 pontos fortes e 3 pontos fracos identificados a partir das avaliações.

        # Formato de Saída

        Nome do Produto:
        Resumo das Avaliações:
        Sentimento geral: [utiliza aqui apenas Positivo, Negativo ou Neutro]
